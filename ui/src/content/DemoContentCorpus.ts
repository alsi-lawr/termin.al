...
const projectReadmes = [
  {
    ...
    collectionPath: "demonstrations/typed-applications",
...
const catalog: VirtualCorpusCatalog = {
  entries: [
    ...
    {
      kind: "directory",
      id: "blog-engineering-interfaces",
      path: "~/blog/engineering/interfaces",
      updatedAt: "2026-01-04T00:00:01.000Z",
      size: 0,
    },
    {
      kind: "directory",
      id: "blog-engineering-demos",
      path: "~/blog/engineering/demos",
      updatedAt: "2026-01-04T00:00:02.000Z",
      size: 0,
    },
    {
      kind: "directory",
      id: "notes-field-notes",
      path: "~/notes/field-notes",
      updatedAt: "2026-01-04T00:00:03.000Z",
      size: 0,
    },
    {
      kind: "directory",
      id: "notes-field-notes-filesystems",
      path: "~/notes/field-notes/filesystems",
      updatedAt: "2026-01-04T00:00:04.000Z",
      size: 0,
    },
    {
      kind: "file",
