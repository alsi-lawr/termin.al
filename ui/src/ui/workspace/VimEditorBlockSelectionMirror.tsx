...
export function VimEditorBlockSelectionMirror({
  ...
  return (
    <div
      ref={mirrorRef}
      className="pointer-events-none absolute inset-0 overflow-auto rounded border border-transparent bg-surface-deepest p-2 font-mono text-sm leading-normal whitespace-pre-wrap break-words text-transparent"
      aria-hidden="true"
    >
